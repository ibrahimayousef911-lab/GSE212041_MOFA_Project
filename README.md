...
- Link: https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE212041
 ...
 Note: Due to file size limitations, raw data files are not included in this repository. 
Please download them directly from GEO.
...
> Note: The original development script GSE212041_MultiOmics_Analysis_original.R is retained for provenance.
...
The original development script is retained for provenance. The organized scripts separate the workflow into focused analytical modules so that preprocessing, differential analysis, enrichment, longitudinal analysis, proteomics, integration, MOFA2 analysis, and final reporting can be maintained independently.

Raw/private input files are not included in the repository. See `data/README.md` for data organization and reproducibility instructions.
